...
class AccountViewController: UIViewController, LabelBootstrap {
    ...
    @IBOutlet weak var viewRedeemPoints: SpringView!
    @IBOutlet weak var tfRedeemReceipt: UITextField!
    ...
    public func getUsers() {
        ...
        awCore.shared().getUser(userId: String(describing: sDefaults().getUserID()!)) { (user) in
