...
class LoginSignUpViewController: ParentLabelVC, LabelBootstrap {
    ...
    @IBOutlet weak var lblHeaderSignInOrMessage: UILabel!
    ...
    */
    ...
    func localizeStrings() {
        ...
        self.lblHeaderSignInOrMessage.text = NSLocalizedString("b7c-ea-VqX.text", comment: "Or (UILabel)")
