...
class ProductDetailViewController: ParentLabelVC, LabelBootstrap {
    ...
    func loadStoreItem() {
        ...
        decodeDesc = storeItem.desc.html2String
        
        self.lblProdDesc.text = decodeDesc
        self.lblDescriptionMoreInfo.text = decodeDesc
        
        if storeItem.price != "" && storeItem.regularPrice != "" && storeItem.price != storeItem.regularPrice {
            ...
            let storePrice = NSMutableAttributedString(string: storeItem.price.formatToPrice())
            ...
            let underlinePrice:NSMutableAttributedString! =  NSMutableAttributedString(string: storeItem.regularPrice.formatToPrice())
            ...
            self.lblProdPrice.attributedText = tmpPrice
        } else {
