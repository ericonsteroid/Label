...
class FashionDetailViewController: ParentLabelVC, LabelBootstrap {
    ...
    func loadStoreItem() {
        ...
        self.lblProdPrice.text = awCore.shared().getMinimumPriceForVariation(variations: storeItem.variation)
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        if firstAttrName != "" || firstAttrName != nil || secondAttrName != "" || secondAttrName != nil
        {
            ...
            if styleType == "1" {
                ...
                for variation in variations {
                    for attr in variation.attributes {
                        if self.storeItem.attributes.count == 1 {
                            if attr.option == optionSize {
