...
class SettingsTableViewController: UITableViewController, LabelBootstrap {
    ...
    /**
     service - Instance of the Woocommerce connection
     user - Users model from Woocommerce Label plugin
     */
    var service:awCore!
    var user:sLabelUser!
    ...
    func localizeStrings() {
        ...
        self.lblChangePassword.text = NSLocalizedString("ncr-6Z-6YE.text", comment: "Change Password (UILabel)")
